...
(function(){
	ebx.stdout = {"total":29,"rows":[
		...
		{"name":"产品类型","value":"","group":"必填信息","editor":{"type":"droplist","options":{"style":"biOpen2","validType":"combogridValue","required":true,"idField":"id","textField":"title","rownumbers":true,"panelWidth":250,"template":84}},"field":"productclass"},
