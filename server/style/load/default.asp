...
(function(){
	...
	data = {"total":11,"rows":[
		...
		{"name":"名称","value":title,"group":"必填信息","editor":{"type":"validatebox", "options":{"required":true}},"field":"title"},//validatebox校验录入值合法性的支持方法
		...
		{"name":"高度","value":Height,"group":"其他","editor":{"type":"validatebox", "options":{"required":false,"validType":"Number"}},"field":"Height"},
		{"name":"宽度","value":Width,"group":"其他","editor":{"type":"validatebox", "options":{"required":false,"validType":"Number"}},"field":"Width"}
	]};
	ebx.stdout = data;
})();
%>